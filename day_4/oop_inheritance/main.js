localStorage.ziv = "ziv"
console.log(`from local storage: ${localStorage.ziv}`)
class Person {
...
class Principal extends Person{
    ...
    transferStudent(student, principal){
        let studentIndex = this.students.findIndex(s => s.name === student.name)
        let transferred = this.students.splice(studentIndex,1);
        principal.recruitStudent(transferred);
    }
}
